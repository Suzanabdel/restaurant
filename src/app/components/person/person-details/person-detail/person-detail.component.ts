...
import { ConfirmationDialogComponent } from 'src/app/layouts/shared/dialoge/confirmation-dialog/confirmation-dialog/confirmation-dialog.component';
import { PersonManagementComponent } from '../../person-managment/person-management/person-management.component';
...
export class PersonDetailsComponent {
  ...
  public displayedColumns: string[] = ['productName', 'price', 'type'];
